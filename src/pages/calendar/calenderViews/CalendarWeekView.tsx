          ...
          <div className="sticky top-0 z-10 flex border-b border-[#94A3B8] bg-white">
            ...
            <div className="flex flex-1">
              {weekDays.map((day, i) => (
                ...
                >
                  <div className="text-lg font-bold text-black">{format(day, 'd MMM')}</div>
                  <div className="text-sm font-medium text-black">{format(day, 'EEEE')}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative flex">
            ...
            <div className="relative flex flex-1">
              ...
              <div className="absolute inset-0 flex">
                {weekDays.map((_, i) => (
                  <div key={i} className="flex-1 border-r border-[#94A3B8] last:border-r-0" />
                ))}
              </div>
